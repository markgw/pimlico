...
def generate_docs_for_pymod(module, output_dir, test_refs={}, example_refs={}):
    """
...
def generate_docs_for_pimlico_mod(module_path, output_dir, submodules=[], test_refs={}, example_refs={}):
