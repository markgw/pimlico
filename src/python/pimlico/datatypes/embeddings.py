...
.. todo::
   ...
   Not yet finished implementing this. TSVVecFiles uses NamedFileCollection, which
   I'm still in the process of implenting. Once that's finished (with unit test)
   add TSVVecFiles.
